...
- "project_knowledge" — about one of our internal projects, services, tickets or documents, as they are today. Example: "How does SMILE handle refunds?"
- "change_impact" — about changing one of our systems, or about what would happen if it changed. The user wants to act, not just understand. Examples: "What should I change to move the DAG schedule to Friday?", "What happens if I change the pkl path?", "If I add a new spend domain, what do I need to update?", "Is it safe to turn off that task?", "How do I enable X?". Signals: "what should I change", "how do I add/enable/disable/move", "what happens if", "what breaks", "is it safe to", "what needs updating". A question that merely asks how something currently works is NOT this — "how does the scheduler work?" is project_knowledge, "how do I change the scheduler?" is change_impact.
